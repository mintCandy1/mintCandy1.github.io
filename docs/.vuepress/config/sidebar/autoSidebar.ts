 ...
 */
const getAllFiles = (dirname: string = "notes", rpath: string, SuffixIncludes: string | string[]): Array<string> => {
...
const getAllDirs = (dirname: string = "notes", mypath: string = ".", unDirIncludes: Array<string>, SuffixIncludes: string | string[]) => {
  // 获取目录数据
  let result = {};
